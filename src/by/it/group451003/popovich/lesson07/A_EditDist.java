package by.it.group451003.popovich.lesson07;
...
public class A_EditDist {
    ...
    int getDistanceEdinting(String one, String two) {
        ...
        if (one.isEmpty()) {
            ...
            int cost = (one.charAt(one.length() - 1) == two.charAt(two.length() - 1)) ? 0 : 1; // стоимость замены, 0 - если одинаковые

            // Рекурсивное вычисление трех возможных операций
